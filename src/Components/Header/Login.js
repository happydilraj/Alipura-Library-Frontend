...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch( `${process.env.REACT_APP_API_URL}/login`, { // Update the URL as needed
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                // Check for specific status codes, for example:
                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {/* <a href="#" className="text-black text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a> */}
                        </div>
